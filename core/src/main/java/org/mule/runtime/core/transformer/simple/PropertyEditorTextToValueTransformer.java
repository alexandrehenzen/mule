...
/**
 * <code>PropertyEditorTextToValueTransformer</code> adapts a {@link PropertyEditor} instance allowing it to be used to
 * internalTransform from a String to another type in Mule
 */
